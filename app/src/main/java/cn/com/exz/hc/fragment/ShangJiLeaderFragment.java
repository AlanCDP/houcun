...
import cn.com.exz.hc.adapter.LeaveAdapter1;
...
public class ShangJiLeaderFragment extends MyBaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public static ShangJiLeaderFragment getInstance(String title) {
        ShangJiLeaderFragment sf = new ShangJiLeaderFragment();
        sf.mTitle = title;
        return sf;
    }
