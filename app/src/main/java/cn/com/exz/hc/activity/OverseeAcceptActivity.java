...
import cn.com.exz.hc.fragment.NoOverseeAcceptFragment;
...
public class OverseeAcceptActivity extends BaseActivity{
    @BindView(R.id.mLeft)
    TextView mLeft;
    ...
    public void init() throws Exception {
        ...
        mFragments.add(NoOverseeAcceptFragment.getInstance("0"));
        mFragments.add(NoOverseeAcceptFragment.getInstance("1"));
