...
import cn.com.exz.hc.adapter.UnitAdapter;
...
public class UnitActivity extends Activity {
    ...
    private List<ThreeDataModel.DepartListBean> list = new ArrayList<>();
    private List<ThreeDataModel.DepartListBean> data = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        edSearch.setHint("请选择单位");

        list = (List<ThreeDataModel.DepartListBean>) getIntent().getSerializableExtra("list");
    ...
    private void initView() {
        ...
        recyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                String s = ((ThreeDataModel.DepartListBean) adapter.getData().get(position)).getDepartname();
                Intent intent = new Intent();
                intent.putExtra("name", s);
                intent.putExtra("id", ((ThreeDataModel.DepartListBean) adapter.getData().get(position)).getId());
