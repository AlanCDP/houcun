...
public class DistributingFragment extends MyBaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    private List<AlreadyDistributingEntity> list;


    public static DistributingFragment getInstance(String title) {
        DistributingFragment sf = new DistributingFragment();
        sf.mTitle = title;
        return sf;
    }
    ...
    private void initPort() {
        ...
        params.put("rows", "10");
        params.put("type", "dispatch");
        params.put("dispatchStatus", mTitle);
        params.put("acceptStatus", "");
