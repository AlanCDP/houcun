...
public class LeaveAdapter1 extends BaseQuickAdapter<LeaveListBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, LeaveListBean item) {
        ...
        post.setText(String.format("请假人：%s", item.getSupervisor()));
