...
import cn.com.exz.hc.fragment.ResponsibilityCheckFragment;
...
public class ResponsibilityCheckActivity extends BaseActivity {
    @BindView(R.id.mLeft)
    TextView mLeft;
    ...
    public void init() throws Exception {
        ...
        mFragments.add(ResponsibilityCheckFragment.getInstance("2"));
        mFragments.add(ResponsibilityCheckFragment.getInstance("3"));
