...
import cn.com.exz.hc.fragment.LeaveFragment;
import cn.com.exz.hc.fragment.LeaveListFragment;
...
public class LeaveActivity extends BaseActivity {
    ...
    public void init() throws Exception {
        ...
        mFragments.add(LeaveFragment.getInstance("0"));
        mFragments.add(LeaveListFragment.getInstance("1"));
        mFragments.add(LeaveListFragment.getInstance("4"));
