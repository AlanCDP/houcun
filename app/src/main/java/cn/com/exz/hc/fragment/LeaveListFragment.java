...
public class LeaveListFragment extends MyBaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public static LeaveListFragment getInstance(String title) {
        LeaveListFragment sf = new LeaveListFragment();
        sf.mTitle = title;
        return sf;
    }
