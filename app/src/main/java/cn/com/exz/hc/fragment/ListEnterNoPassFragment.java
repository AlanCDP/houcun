...
import cn.com.exz.hc.activity.ListEnterNoPassActivity;
...
public class ListEnterNoPassFragment extends MyBaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener{
    ...
    public static ListEnterNoPassFragment getInstance(String title) {
        ListEnterNoPassFragment sf = new ListEnterNoPassFragment();
        sf.mTitle = title;
        return sf;
    }
        ...
        recyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (mTitle.equals("-4")){
                    ...
                    List<ListEnterNoPassEntity> list  = new ArrayList<>();
                    list.add((ListEnterNoPassEntity)adapter.getData().get(position));
                    Intent intent = new Intent(getContext(),ListEnterNoPassActivity.class);
