...
public class CheckActivity extends BaseActivity {
    ...
    private String checkResult="2";//1驳回   2通过
    ...
    public void init() throws Exception {
        ...
        standardScore.setText(getIntent().getStringExtra("point"));
        score1.setText(getIntent().getStringExtra("score"));
        checkMan.setText(getIntent().getStringExtra("checkPeople"));
        completion.setText(getIntent().getStringExtra("completion"));
...
//
    ...
    private void initPort() {
        ...
        params.put("limitDate", getIntent().getStringExtra("limitTime"));
        params.put("score", StrScore);
        params.put("scoreId", scoreId);



        OkGo.<NetEntity<String>>post(FusionField.ResponsibilityCheck_Commit)
                .params(params)
                .tag(this)
